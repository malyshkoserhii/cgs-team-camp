...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader"
    ...
    Confirm your email for Your Todo App!!!
  </div>
  >
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              ...
              <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account
                at <a href="${frontendUrl}">Todo List app</a>, you can safely delete this email.</p>
            </td>
          </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          ...
                          <a href="${frontendUrl}/verify/${verificationToken}" target="_blank"
