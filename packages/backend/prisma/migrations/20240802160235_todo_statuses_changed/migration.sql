/*
  ...
  - The values [Todo,OnHold,Done] on the enum `TodoStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TodoStatus_new" AS ENUM ('InProgress', 'Completed');
...
ALTER TABLE "Todo" ALTER COLUMN "status" SET DEFAULT 'InProgress';
COMMIT;
